...
To build the final jar and optimize the spingularchatsprint1 application for production, run:
...
[definitelytyped]: http://definitelytyped.org/ '# spingularchatsprint1'
